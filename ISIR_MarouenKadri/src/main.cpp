...
namespace RT_ISICG
{
	int main( int argc, char ** argv )
	{
		...
		//PerspectiveCamera camera( Vec3f( 0,0,-2) , Vec3f( 0, 0, 79 ) , Vec3f (1,1,1)  , 60, float( imgWidth ) / imgHeight ); 
		//PerspectiveCamera camera(Vec3f( 1, 0, 0 ), Vec3f( 1, 0, 1 ), Vec3f( 1, 1, 1 ), 60, float( imgWidth ) / imgHeight ); 
		
		
		PerspectiveCamera camera( Vec3f( 0.f, 2.f, -6.f ),Vec3f( 0.f, 0.f, 50.f ),Vec3f( 0.f, 1.f, 0.f ),60.f,float( imgWidth ) / imgHeight );
